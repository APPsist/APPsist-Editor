...
import de.appsist.ape.utils.GuideSerializer;
...
public class PersistenceHandler {
    ...
    /*public void writeJsonGuide (Guide guide, JsonGuide jsonGuide) throws IOException {
        File guideDir = new File(guidesDir.getAbsolutePath() + "/" + guide.getId());
        if (!guideDir.exists()) guideDir.mkdir();
        ...
        File jsonGuideDescriptorFile = new File(guideDir, "guide.json");
        JsonUtil.writeJson(jsonGuide.asJson(), jsonGuideDescriptorFile, true);
    }*/
    
    /*public void writeContent(Guide guide, JsonContent content) throws IOException {
        ...
        File jsonContentDescriptorFile = new File(contentDir, "content.json");
        JsonUtil.writeJson(content.asJson(), jsonContentDescriptorFile, true);
    }*/
...
/*    public void writeJsonStepDescriptor(Guide guide, JsonGuide jsonguide, ContentDescriptor contentDescriptor, JsonContent content) throws IOException {
        File contentPackageDir = new File(guidesDir.getAbsolutePath() + "/" + jsonguide.getId() + "/content/" + contentDescriptor.getId());
        if (!contentPackageDir.exists()) contentPackageDir.mkdirs();

        //String serializedContentDescriptor = ContentSerializer.writeAsXML(contentDescriptor, false);
        
        File jsonStepDescriptorFile = new File(contentPackageDir, "content.json");
        JsonUtil.writeJson(content.asJson(), jsonStepDescriptorFile, true);
    }*/
    ...
    public void deleteGuide(String guideId) {
        ...
        /*File jsonFile = new File (guidesDir.getAbsolutePath() + "/" + guideId + "/" + "guide.json");
        boolean success = jsonFile.delete();
        if (!success){
            LOGGER.warning("Couldn't delete" + jsonFile.getAbsolutePath());
        }*/
        if (guideDir.exists()) {
            deleteDir(guideDir);
        }
