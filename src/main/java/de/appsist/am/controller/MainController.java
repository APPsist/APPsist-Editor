...
import de.appsist.am.ActionManager;
import de.appsist.am.MainApp;
import de.appsist.am.model.ChapterItem;
...
import de.appsist.am.MainApp.AppScene;
import de.appsist.am.model.NodeItem;
import de.appsist.am.PersistenceHandler;
import de.appsist.am.Session;
import de.appsist.am.actions.AddHintAction;
import de.appsist.am.actions.AddWarningAction;
import de.appsist.am.actions.ChangeMediaAction;
import de.appsist.am.actions.EditHintAction;
import de.appsist.am.actions.EditWarningAction;
import de.appsist.am.actions.RemoveHintAction;
import de.appsist.am.actions.RemoveMediaAction;
import de.appsist.am.actions.RemoveWarningAction;
import de.appsist.am.model.ContentModel;
import de.appsist.am.model.GuideModel;
import de.appsist.am.model.HintModel;
import de.appsist.am.model.StepItem;
...
import de.appsist.am.Action;
import de.appsist.am.ActionListener;
import de.appsist.am.actions.AddChapterAction;
import de.appsist.am.actions.AddStepAction;
import de.appsist.am.actions.AddToolAction;
import de.appsist.am.actions.BaseAction;
import de.appsist.am.actions.DeleteNodeAction;
import de.appsist.am.actions.EditStepInfoAction;
import de.appsist.am.actions.MoveNodeAction;
import de.appsist.am.actions.RemoveToolAction;
import de.appsist.am.actions.SelectVRNodeAction;
import de.appsist.am.model.IntegerParameter;
import de.appsist.am.model.Parameter;
import de.appsist.am.model.StepModel;
import de.appsist.am.model.Tool;
import de.appsist.am.model.VRMethod;
import de.appsist.am.model.VRNode;
...
import de.appsist.ape.utils.XMLUtils;
...
import static de.appsist.am.MainApp.APPSIST_STRING;
import static de.appsist.am.MainApp.GLASSROOM_STRING;
import static de.appsist.am.MainApp.ICON_APPSIST_STRING;
import static de.appsist.am.MainApp.ICON_GLASSROOM_STRING;
import static de.appsist.am.MainApp.themeOption;
...
//                JsonContent jsoncontent = new JsonContent(content.getId());
//                jsoncontent.setTitle(content.getBean().getTitle());
 //               jsoncontent.setDescription("Derzeit ist keine Beschreibung der Anleitung verfügbar.");
 //               persistenceHandler.writeJsonStepDescriptor(session.getGuide().getBean(), session.getJsonGuide(), content.getBean(), jsoncontent);
    ...
    */
    ...
    private void showLoginScreen(ActionEvent event) {
        ...
        Stage stage = new Stage();
        stage.setScene(scenes.get(AppScene.LOGIN_SCREEN));
    ...
    public void editChapter(ActionEvent event) {
        ...
        //JsonGuide jsonguide = session.getJsonGuide();
 ...
 //               persistenceHandler.writeJsonGuide(guide, jsonguide);
            } catch (IOException ex) {
...
/*        JsonContent content = new JsonContent(UUID.randomUUID().toString());
        content.setLanguageId(MainApp.LANG);
        content.setTitle("[Neue Anleitung]");
        content.setDescription("Derzeit ist keine Beschreibung der Anleitung verfügbar.");
        JsonGuide newjsonGuide = new JsonGuide(newGuide.getId());
        newjsonGuide.setContentId(MainApp.LANG, content.getId());*/
        //TODO: Implement JsonGuideManager
//        session.setJsonGuide(newjsonGuide);   
 //       session.setJsonContent(content);
    ...
    //        persistenceHandler.writeJsonGuide(newGuide, newjsonGuide);
    //        persistenceHandler.writeContent(newGuide, content);
    ...
    private String getCurrentThemeLogoAsString(){
       if(themeOption.equalsIgnoreCase(GLASSROOM_STRING)){
            return "/logos/"+ICON_GLASSROOM_STRING;
        }
        else if(themeOption.equalsIgnoreCase(APPSIST_STRING)){
            return "/logos/"+ICON_APPSIST_STRING;
        }
    ...
    private void deleteGuide(ActionEvent event) {
        ...
        ((Stage) alert.getDialogPane().getScene().getWindow()).getIcons().add(new Image(MainApp.class.getResourceAsStream(getCurrentThemeLogoAsString())));
