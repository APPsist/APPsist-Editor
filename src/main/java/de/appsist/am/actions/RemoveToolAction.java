 ...
 */
public class RemoveToolAction extends BaseAction {
    private final static Logger LOGGER = Logger.getLogger(RemoveToolAction.class.getName());
    ...
    public RemoveToolAction(ToolAnnotation toolAnnotation, StepModel step, GuideModel guideModel, PersistenceHandler persistenceHandler) {
